package clv.gui.core 
{
	...
	public interface IComponent 
	{
		...
		function update(cell:Rectangle, scale:Number):void 
		...
		function prepareForUpdate(scale:Number):void;
		
		function set scaleble(value:Boolean):void;
		
		function get appScale():Number;
		
		function get scaleble():Boolean;
		...
		function get layoutBounds():IndependentBounds;
